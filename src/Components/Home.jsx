...
import {
  Eye, EyeOff, X, User, Twitter, Send, MessageSquare,
  MessageCircle, Phone, Hash, Github
} from 'lucide-react';

import logo from '../assets/logo.webp';
import bgImage from '../assets/bg_m-cac172cf.webp'; // Your local background image
    ...
    <div style={{
      ...
      <div style={{ position: 'relative', height: '160px' }}>
        ...
        <div style={{ position: 'absolute', top: 0, left: 0, right: 0, padding: '16px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', zIndex: 20 }}>
          <img src={logo} alt="BC.GAME Logo" style={{ height: '24px', width: 'auto' }} />
